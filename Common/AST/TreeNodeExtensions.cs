...
public static class TreeNodeExtensions
{
    ...
    where T : ITreeNode<T>
    {
        ...
        T NodeUnderConsideration = self.GetParent(Root) ?? throw new ArgumentException("Self was equal to Root. This cannot be the case if you want to get information from a parent.");
