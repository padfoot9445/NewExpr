...
{
    static partial class PrimaryParser
    {
        private static CodeGenerator Driver = null;
        ...
        static void ParseValNum(Node self) => ValNumParser.Parse(self, Driver);
        internal static void Parse(Node Self, CodeGenerator Driver)
        {
            PrimaryParser.Driver = Driver;
            Driver.SETCHUNK();
