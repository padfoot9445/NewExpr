    ...
    internal static void Visit(PrimaryNode self, CodeGenerator Driver)
    {
        ...
        (
            ...
            (TypeData.Float,
                ...
                (
                    GetIntParseFunctionFromFloatParseFunction(float.Parse, BitConverter.SingleToUInt32Bits), self,
                    Driver
                )),
            ...
            (TypeData.Double,
                EmitCodeDelegateGenerator
                (
                    GetIntParseFunctionFromFloatParseFunction(double.Parse, BitConverter.DoubleToUInt64Bits), self,
                    Driver
                )),
