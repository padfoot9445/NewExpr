...
using NodeType = Common.AST.DynamicASTNode<SmallLang.Frontend.Parser.ASTNodeType, SmallLang.Metadata.Attributes>;
...
public partial class SmallLangParser
{
    ...
    public NodeType AssignmentOp(NodeType left, LyToken Op, NodeType right)
    {
        ...
        return new NodeType(IToken.NewToken(TokenType.Equals, "Autogenerated equals", Op.Position.Index, Line: Op.Position.Line), [left, new(
    ...
    public NodeType PreCrementOp(LyToken left, NodeType right)
    {
        ...
        return new(IToken.NewToken(TokenType.Equals, "InsertedPostcrement", left.Position.Index, Line: left.Position.Line), [right,
        new(IToken.NewToken(newToken, "InsertedPostcrement", left.Position.Index, Line:left.Position.Line), [right, new(
            IToken.NewToken(TokenType.Number, "1", left.Position.Index, Line:left.Position.Line),
            [],
            ASTNodeType.Primary
        )],
        ASTNodeType.BinaryExpression
