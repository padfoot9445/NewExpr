...
public enum Opcode : OpcodeBackingType
{
    ...
    SWITCH,
    //SWITCH [Length] [StartingIndex] [TypeCode]# SWITCH Length StartIndex, select the correct instruction or instructions based on the TypeCode
    // For i in [1...Length]:
    ...
    Factorial, //Factorial [Type] [Number of exclamation marks]
}