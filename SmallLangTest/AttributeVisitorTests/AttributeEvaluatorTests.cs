...
public class AttributeEvaluatorTests
{
    ...
    public void All_Programs__AttributeVisitor__BeginVisiting__Does_Not_Throw((ISmallLangNode ast, string program) input)
    {

        Assert.That(() => new AttributeEvaluator().BeginVisiting(input.ast), Throws.Nothing, message: input.program);
