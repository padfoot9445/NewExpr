...
static class TokenSrc
{
    public static IToken Addition => IToken.NewToken(TokenType.Addition, "+", -1, null);
    ...
    public static IToken Multiplication => IToken.NewToken(TokenType.Multiplication, "*", -5, null);
}